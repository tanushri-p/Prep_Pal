...
const HeroSection = ({ onInputSubmit }) => {
      ...
      <div className="max-w-4xl w-full text-center space-y-8">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-center mb-6">
            <h1 className="text-6xl md:text-7xl font-bold bg-gradient-to-r from-amber-600 via-orange-500 to-red-500 bg-clip-text text-transparent">
              PrepPal
            </h1>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 max-w-4xl mx-auto">
          ...
          <div className="text-center space-y-3">
            ...
            <h3 className="font-semibold text-gray-800">Form-Based</h3>
            <p className="text-gray-600 text-sm">Easy-to-use form to specify your exact meal planning needs</p>
          </div>
          <div className="text-center space-y-3">
